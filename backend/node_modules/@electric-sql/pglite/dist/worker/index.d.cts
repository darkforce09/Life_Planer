import { n as Extensions, r as PGliteOptions, y as BasePGlite, d as PGliteInterface, s as PGliteInterfaceExtensions, D as DebugLevel, o as ExecProtocolResult, B as BackendMessage, T as Transaction, z as DumpTarCompressionOptions, b as PGlite } from '../pglite-DPkJz6ln.cjs';
...
declare class PGliteWorker extends BasePGlite implements PGliteInterface, AsyncDisposable {
     ...
     * @returns The direct message data response produced by Postgres
     */
    execProtocolRawStream(message: Uint8Array, options: {
